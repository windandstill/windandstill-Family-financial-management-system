...
<div id="tb">
    <div>
        ...
        <a href="javascript:openSecurityFindDialog()" class="easyui-linkbutton" iconCls="icon-lsdd"
           plain="true">查看详细</a>
    </div>
    <div>
        &nbsp;持有人：&nbsp;<input type="text" id="s_username" size="12"
                               onkeydown="if(event.keyCode==13) searchSecurity()"/>
        &nbsp;证券公司：&nbsp;<input type="text" id="s_company" size="12"
                                onkeydown="if(event.keyCode==13) searchSecurity()"/>
        ...
        &nbsp;证券有效期：&nbsp;<input type="text" id="s_searchStarttime" class="easyui-datetimebox" size="18"
                                 onkeydown="if(event.keyCode==13) searchSecurity()"/>
        <span style="font-weight:bold;">&sim;</span>&nbsp;<input type="text" id="s_searchEndtime"
                                                                 class="easyui-datetimebox" size="18"
                                                                 onkeydown="if(event.keyCode==13) searchSecurity()"/>
...
<div id="dlg" class="easyui-dialog" style="width: 730px; height: 250px; padding: 10px 20px" closed="true"
     buttons="#dlg-buttons">
    <form id="fm" method="post">
        <table cellspacing="8px">
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>证券有效开始时间</td>
                <td><input id="starttime" name="starttime" class="easyui-datetimebox" required="true"
                           style="width:175px">&nbsp;<font
                        color="red">*</font></td>
            </tr>
            <tr>
                <td>证券有效结束时间</td>
...
<div id="finddlg" class="easyui-dialog" style="width: 670px;height:300px;padding: 10px 20px" closed="true"
     buttons="#finddlg-buttons">
